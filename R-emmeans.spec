...
Version  : 1.5.2.1
Release  : 42
URL      : https://cran.r-project.org/src/contrib/emmeans_1.5.2-1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/emmeans_1.5.2-1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1603727957
