...
Version  : 1.7.4.1
Release  : 67
URL      : https://cran.r-project.org/src/contrib/emmeans_1.7.4-1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/emmeans_1.7.4-1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652683046
